...
1. Create a new panel below the last panel we just worked on, title it “Cohort”, ensure your date range for POT1 is March 18-30, 2020 and select the Cohort Table visualization.
...
- For example, there were 386 calls on March 18. By March 30 (12 days later), 36 of those calls were repeat callers
...
Next we will review [Sequential Filtering](https://github.com/adobe/AEP-Hands-on-Labs/blob/master/labs/fsi/CJA/SequentialFiltering.md)
